...
File-output evals often need format-specific tools in `runtime.dockerfile`. Install only what the runner or grader actually needs. When in doubt, choose the recipe for the primary output type:
